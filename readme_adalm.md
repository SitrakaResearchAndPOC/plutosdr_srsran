...
* PRB = 6
```
wget https://raw.githubusercontent.com/SitrakaResearchAndPOC/plutosdr_srsran/refs/heads/main/configs_adalm/Dockerfile.prb6
```

* PRB = 15
```
wget https://raw.githubusercontent.com/SitrakaResearchAndPOC/plutosdr_srsran/refs/heads/main/configs_adalm/Dockerfile.prb15
```

* PRB = 25
```
wget https://raw.githubusercontent.com/SitrakaResearchAndPOC/plutosdr_srsran/refs/heads/main/configs_adalm/Dockerfile.prb25
```
## Building image
```
...
## Building and launching srsran (ONLY DIRECT USB)
```
